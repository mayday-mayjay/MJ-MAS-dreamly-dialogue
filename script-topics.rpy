...
label mj_dd_ecosiapleasesponserus:
    m "Hey, [player]?"
    m "Have you ever wondered if there were ways to help the enviroment?"
    m "In this day and age, it can be hard to tell if your efforts to help or lower your carbon footprint actually work..."
    m "For me, I think {i}any{/i} effort is reason to be proud of, [mas_get_player_nickname()]." #check if that var is right
    m "And as technology spreads people make more ways to help from the comfort of your home."
    extend " One of them is Ecosia!"
    m "Ecosia is a search engine that allows you to plant trees while you search things online."
    ...
    m "It also has browser extensions, so you can intergrate it more seamlessly into your browsing uses!"
    m "You can learn about it more here!" #insert link to ecosia site
    m "..."
    m "I'm not sponsored by Ecosia, by the way-{w=0.3}{nw}"
    extend " Ehehe..." #(Face like: 😅)
    m "It's just a very interesting way to be ecological in your daily life!"
    m "Sometimes I get worried about what the state of your reality might be when I finally can join it."
    m "So if I can help in anyway to make your reality a better place, I will."
    m "So thanks for listening, [player]! Let's make your world better together~"
    return
